...
class AdataSpectrixDetail extends StatelessWidget {
  const AdataSpectrixDetail({super.key});
                              ...
                              builder: (context, constraints) {
                                return Center(
                                  child: Container(
                                    ...
                                    child: Image.asset(
                                      'assets/images/ram/AdataSpectrix.jpg',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                );
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SpecificationItem(
                              'Heat Spreader: ',
                              'Aluminum with Diamond-Cut Design',
                              isDarkMode: isDarkMode,
                            ),
                            SpecificationItem(
