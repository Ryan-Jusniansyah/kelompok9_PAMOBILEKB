...
class TeamCreateDetail extends StatelessWidget {
  const TeamCreateDetail({super.key});
                              ...
                              builder: (context, constraints) {
                                return Center(
                                  child: Container(
                                    ...
                                    child: Image.asset(
                                      'assets/images/ram/TeamCreate.jpg',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                );
