...
class VColorMantaDetail extends StatelessWidget {
  const VColorMantaDetail({super.key});
                              ...
                              builder: (context, constraints) {
                                return Center(
                                  child: Container(
                                    ...
                                    child: Image.asset(
                                      'assets/images/ram/VColorManta.jpg',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                );
