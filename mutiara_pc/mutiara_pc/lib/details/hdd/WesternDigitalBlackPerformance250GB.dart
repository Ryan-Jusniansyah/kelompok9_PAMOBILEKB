...
class WesternDigitalBlackPerformance250GBDetail extends StatelessWidget {
  const WesternDigitalBlackPerformance250GBDetail({super.key});
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Western Digital Black Performance 250GB',
                              style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: isDarkMode ? Colors.white : Colors.black,
