...
class WesternDigitalRedPlus4TBDetail extends StatelessWidget {
  const WesternDigitalRedPlus4TBDetail({super.key});
                              ...
                              builder: (context, constraints) {
                                return Center(
                                  child: Container(
                                    ...
                                    child: Image.asset(
                                      'assets/images/hdd/WesternDigitalRedPlus4TB.png',
                                      fit: BoxFit.contain,
                                    ),
                                  ),
                                );
